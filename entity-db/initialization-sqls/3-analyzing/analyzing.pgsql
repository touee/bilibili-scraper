...
CREATE FUNCTION "Analyzing"."fn_refreshCertifiedVideoAfterModifyCertifiedTags"()
    RETURNS trigger AS $$
        BEGIN
...
--     EXECUTE PROCEDURE "Analyzing"."fn_refreshCertifiedVideoAfterModifyCertifiedTags"();
